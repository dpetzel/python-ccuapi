...
if django_settings:
    try:
        AKAMAI_USERNAME     =   django_settings.get('AKAMAI_USERNAME', AKAMAI_USERNAME)
        AKAMAI_PASSWORD     =   django_settings.get('AKAMAI_PASSWORD', AKAMAI_PASSWORD)
        AKAMAI_NOTIFY_EMAIL =   django_settings.get('AKAMAI_NOTIFY_EMAIL', AKAMAI_NOTIFY_EMAIL)
    except ImportError:
